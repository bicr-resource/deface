function	Vspm = vb_analyze_to_spm_right(Vana,Vdim,Vsize,nflag)
% change Analyze Left-hand voxcel coordinate to Right-hand SPM (m) coord.
%  Vspm = vb_analyze_to_spm_right(Vana)            : normal vector
%  Vspm = vb_analyze_to_spm_right(Vana,Vdim,Vsize) : coordinate vector
%  Vspm = vb_analyze_to_spm_right(Vana,Vdim,Vsize,nflag)
% --- Input
