function	Vspm = vb_analyze_right_mm_to_spm_right(Vana,Vdim,Vsize,nflag)
% change Analyze Right-hand mm coordinate to Right-hand SPM (m) coord.
%  Vspm = vb_analyze_right_mm_to_spm_right(Vana)            : normal vector
%  Vspm = vb_analyze_right_mm_to_spm_right(Vana,Vdim,Vsize) : coordinate vector
%  Vspm = vb_analyze_right_mm_to_spm_right(Vana,Vdim,Vsize,nflag)
% --- Input
